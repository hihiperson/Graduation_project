...
public class Msg_HttpClientUtil {
    ...
    private static Msg_HttpClientUtil instance = null;
    private Msg_HttpClientUtil(){}
    public static Msg_HttpClientUtil getInstance(){
        if (instance == null) {
            instance = new Msg_HttpClientUtil();
        }
        return instance;
    }
